...
Source0: hydra-worker-map-sort-1.1.tar.gz
License: MIT
Group: custom
...
install -m 0644 hydra-worker-map-sort.conf $RPM_BUILD_ROOT/etc/hydra/hydra-worker-map-sort.conf
%clean
...
%dir /etc/hydra
/etc/hydra/hydra-worker-map-sort.conf
/etc/init.d/hydra-worker-map-sort
